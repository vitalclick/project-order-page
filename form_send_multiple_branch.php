...
<head>
    ...
    <title>Request a Quote | VitalClick</title>
...
<?php
						...
						$to = "info@vitalclick.co.za";	/* YOUR EMAIL HERE */
						$subject = "Quotation from VITALCLICK WEBSITE";
						$headers = "From: Quotation from ONLINE WEBSITE <info@vitalclick.co.za>";
						$message = "DETAILS\n";
						...
						if (isset($_POST['branch_4_answers']) && $_POST['branch_4_answers'] != "")
							{
							$message.= "\nWhat Type of Design do you need:\n";
							foreach($_POST['branch_4_answers'] as $value)
								{
								$message.= "-" . trim(stripslashes($value)) . "\n";
								};
							}
						...
						$userheaders = "From: info@vitalclick.co.za\n";
